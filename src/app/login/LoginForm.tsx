  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7faf7] px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="mb-1 text-center text-2xl font-bold text-[#1a2e1c]">Welcome back</h1>
        <p className="mb-7 text-center text-sm text-[#4a6b4e]">Log in to MathStep</p>

        {justReset && (
          <div className="mb-4 rounded-lg border border-[#bae0bd] bg-[#f2faf3] px-3.5 py-2.5 text-sm text-[#1a2e1c]">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="text-right">
                <Link
                  ...
                  className="text-xs font-medium text-[#2d6a35] underline underline-offset-2"
                >
                  Forgot password?
                </Link>
              </div>
        ...
        <p className="mt-5 text-center text-sm text-[#4a6b4e]">
          ...
          <Link href="/signup" className="font-semibold text-[#2d6a35] underline underline-offset-2">
            Sign up
          </Link>
        </p>
      </div>
