    ...
    <div className="flex min-h-screen flex-col bg-[#f7faf7]">
      ...
      <section className="px-6 py-14">
        <div className="mx-auto max-w-2xl">
          <h2 className="mb-8 text-center text-2xl font-bold text-[#1a2e1c]">Frequently asked questions</h2>

          <div className="space-y-4">
            {[
              {
                q: 'What is MathStep?',
                a: 'MathStep is a structured daily math practice app for children. It covers topics from basic addition through algebra, using short timed worksheets, instant marking, and step-by-step worked examples.',
              },
              {
                q: 'Who is it for?',
              ...
              <div key={q} className="rounded-xl border border-[#bae0bd] bg-white p-5">
                <p className="font-semibold text-[#1a2e1c] mb-1">{q}</p>
